// Vendored from TLGS tlgsutils/url_parser.hpp.
#pragma once
...
struct Url {
    ...
    bool operator==(const Url& other) const {
        return protocol_ == other.protocol_ && host_ == other.host_ && path_ == other.path_ &&
               param_ == other.param_ && fragment_ == other.fragment_ && port_ == other.port_;
    }
    bool operator<(const Url& other) const {
